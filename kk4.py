...
print("Karar agaç modeli R2:{} RMSE:{}".format(r2dt,rmsedt))
print("Bagg modeli R2:{} RMSE:{}".format(r2bg,rmsebg))
print("Random forest modeli R2:{} RMSE:{}".format(r2rf,rmserf))

#dtparametreler={"min_samples_split":range(2,25),"max_leaf_nodes":range(2,20)}
